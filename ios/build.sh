...
NATIVE_GAME_ID="${DOLBUNDLER_NATIVE_GAME_ID:-}"
NATIVE_GENERATED_DIR="${DOLBUNDLER_NATIVE_GENERATED_DIR:-}"
NATIVE_MODULES="${DOLBUNDLER_NATIVE_MODULES:-}"
...
cmake -S "$HERE" -B "$BUILD" -G Xcode \
  ...
  -DDOLBUNDLER_NATIVE_GAME_ID="$NATIVE_GAME_ID" \
  -DDOLBUNDLER_NATIVE_GENERATED_DIR="$NATIVE_GENERATED_DIR" \
  -DDOLBUNDLER_NATIVE_MODULES="$NATIVE_MODULES" \
