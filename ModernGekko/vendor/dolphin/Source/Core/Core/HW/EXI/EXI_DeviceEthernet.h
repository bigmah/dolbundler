...
private:
  ...
  protected:
    ...
    defined(__OpenBSD__) or defined(__EMSCRIPTEN__)
...
#elif defined(__linux__) || defined(__APPLE__) || defined(__FreeBSD__) || defined(__OpenBSD__) or defined(__EMSCRIPTEN__)
    int fd = -1;
#endif
  };
...
#if defined(WIN32) || defined(__linux__) || defined(__APPLE__) || defined(__FreeBSD__) ||          \
    defined(__OpenBSD__) || defined(__NetBSD__) || defined(__HAIKU__) or defined(__EMSCRIPTEN__)
